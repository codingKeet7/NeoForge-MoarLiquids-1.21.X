package net.goldengoose.moarliquidsmod.fluid;

import net.goldengoose.moarliquidsmod.MoarLiquidsMod;
import net.goldengoose.moarliquidsmod.fluid.custom.MetalFluidType;
...
public class ModFluidTypes extends FluidType {
    ...
    public static DeferredRegister<FluidType> FlUID_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.FLUID_TYPES, MoarLiquidsMod.MOD_ID);
