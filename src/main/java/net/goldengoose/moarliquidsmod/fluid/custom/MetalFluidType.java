package net.goldengoose.moarliquidsmod.fluid.custom;
...
public class MetalFluidType extends FluidType {
    ...
    public MetalFluidType(Properties properties, String name, Vector3f color,  float fogStart, float fogEnd) {
        super(properties);
        this.STILL = ResourceLocation.fromNamespaceAndPath(MoarLiquidsMod.MOD_ID, "block/"+ name +"_still");
        this.FLOW = ResourceLocation.fromNamespaceAndPath(MoarLiquidsMod.MOD_ID, "block/"+ name +"_flow");
        this.COLOR = color;
